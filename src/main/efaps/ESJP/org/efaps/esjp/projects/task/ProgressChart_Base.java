 ...
 * @version $Id$
 */
@EFapsUUID("4181bbb0-0cd6-4f03-a2a6-cae3af02205f")
@EFapsRevision("$Rev$")
public abstract class ProgressChart_Base
    extends LineChart
{
    ...
    /**
     * @param _parameter        Parameter as passed by the eFaps API
     * @param _seriesCollection collectionof series
     * @param _from             from
     * @param _until            until
     * @return ProgressSeries
     */
    ...
    /**
     * Get a new Instance of ProgressSeries.
     *
     * @return new ProgressSeries
     */
    public ProgressSeries getProgressSeries()
    {
        return new ProgressSeries();
    }
